...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/genexample/sysUser/">代码生成示例列表</a></li>
		<li class="active"><a href="${ctx}/genexample/sysUser/form?id=${sysUser.id}">代码生成示例<shiro:hasPermission name="genexample:sysUser:edit">${not empty sysUser.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="genexample:sysUser:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="sysUser" action="${ctx}/genexample/sysUser/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<div class="form-actions">
			<shiro:hasPermission name="genexample:sysUser:edit"><input id="btnSubmit" class="btn btn-primary" type="submit" value="保 存"/>&nbsp;</shiro:hasPermission>
